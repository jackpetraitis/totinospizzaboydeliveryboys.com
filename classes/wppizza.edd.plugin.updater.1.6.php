...
class WPPIZZA_EDD_SL_UPDATER {
    ...
    function __construct( $_api_url, $_plugin_file, $_api_data = null ) {
		...
		/*
			fix for plugins that declare __FILE__ in v2x.php instead of using 
			constant XX_XX_EDD_FILE in plugin master
		*/
		$_fix = substr(basename($_plugin_file), 0, 3); 
		if($_fix == 'v2x'){
			$_basedir = dirname($_plugin_file);
			$_basename = basename($_basedir).'.php';
			/** use main plugin file */			
			$_plugin_file = $_basedir . DIRECTORY_SEPARATOR . $_basename ;
		}
